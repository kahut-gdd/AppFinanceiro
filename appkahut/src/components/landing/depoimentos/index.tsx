            ...
            <div className={`flex flex-col justify-center items-center`}>
                ...
                <div className="flex justify-center xl:justify-between items-center justify-items-center gap-7 w-full flex-wrap">
                    <Depoimento
                        ...
                        texto="Sou desenvolvedor e investidor."
                    />
                    <Depoimento
                        ...
                        nome="Daniele"
                        titulo="Diretora Financeiro"
                        texto="Agora consigo aplicar melhor meu dinheiro."
                        destaque
                    />
                    <Depoimento
                        ...
                        nome="Esther"
                        titulo="Design"
                        texto="Melhorei bastante minha condição financeira."
                    />
                </div>
            </div>
        </Area>
